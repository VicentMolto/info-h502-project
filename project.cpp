...
int main(int argc, char* argv[])
{
	...
	model1 = glm::translate(model1, glm::vec3(0.0, 0.0, -2.0));
	model1 = glm::scale(model1, glm::vec3(0.5, 0.5, 0.5));

	glm::mat4 inverseModel1 = glm::transpose( glm::inverse(model1));

	glm::mat4 model2 = glm::mat4(1.0);
	model2 = glm::translate(model2, glm::vec3(0.0, 0.0, -1.0));
	...
	glm::vec3 materialColour1 = glm::vec3(0.5f,0.6,0.8);
	glm::vec3 materialColour2 = glm::vec3(0.9f,0.6,0.2);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shader.setMatrix4("M", model1);
		shader.setMatrix4("itM", inverseModel1);
		...
		shader.setVector3f("materialColour", materialColour2);
